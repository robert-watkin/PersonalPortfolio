        ...
        <div class="grid grid-cols-3 my-24">
            <div class="col-span-2 mr-4">
                ...
                <p class="mt-4 text-sm text-text">Hello! I'm Robert Watkin, a junior software engineer from the North
                    ...
                    primarily
                    work
                    with Laravel, the PHP framework. In fact, I used Laravel to build this website, which showcases some
                    of my projects.
                    <br /><br />
            ...
            <svg class="mx-auto w-3/4 my-auto" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                ...
                <path d="M531.73,169.12c1.98-.49,3.96-.95,5.96-1.38V329.55h-5.96Z" transform="translate(-311 -161)"
                    fill="#ccc" />
                <path d="M652.37,165.73c1.99.37,3.98.75,5.96,1.16V329.55h-5.96Z" transform="translate(-311 -161)"
                    fill="#ccc" />
                <path
                ...
                <path d="M711.37,389.8h-14.6a1.1053,1.1053,0,0,0,0,2.21h14.6a1.10511,1.10511,0,0,0,0-2.21Z"
                    transform="translate(-311 -161)" fill="#3f3d56" />
                <path d="M711.37,393.95h-14.6a1.10527,1.10527,0,0,0,0,2.21h14.6a1.10508,1.10508,0,0,0,0-2.21Z"
                    transform="translate(-311 -161)" fill="#3f3d56" />
                <path d="M711.37,398.1h-14.6a1.1053,1.1053,0,0,0,0,2.21h14.6a1.10511,1.10511,0,0,0,0-2.21Z"
                    transform="translate(-311 -161)" fill="#3f3d56" />
